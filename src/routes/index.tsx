...
function IndexPage() {
    return (
        <div className="h-full w-full flex flex-col gap-2 p-2 container mx-auto">
            ...
            <section className="flex-[9] order-1 md:order-2 bg-background rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.15)] border border-border p-4 flex flex-col min-h-0">
            ...
            <section className="flex-[9] md:hidden bg-background rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.15)] border border-border p-4 flex flex-col order-3 min-h-0">
            ...
            <div className="hidden md:flex flex-[9] flex-row gap-2 md:order-3 min-h-0">
